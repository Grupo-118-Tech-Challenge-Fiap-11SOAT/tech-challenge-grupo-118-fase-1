...
public interface IPaymentService
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The payment</returns>
    Task<Payment> ValidateByUuidAsync(Guid uuid, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns></returns>
    Task ConfirmAsync(Order.Entities.Order order, Payment payment, string authorizationCode, CancellationToken cancellationToken = default);
}