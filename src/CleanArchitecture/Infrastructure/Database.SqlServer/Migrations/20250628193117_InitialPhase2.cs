    ...
    public partial class InitialPhase2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateOnly(1990, 1, 1), "98659502000", "admin@admin.com", true, "Admin", "QBYnGddxOZ/VOBgUr1koYDLMawbe/D8NaYYxOXQ0LHN8TO/ysQ5UvBZc70kbQkfXarxn+KobEuH7KpXkiElivg==", "Admin", "Doe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Snack", "Hamburguer de 2 carnes com queijo e presunto. Acompanha de frango e bacon.", true, "Hamburguer 2 carnes", 35.95m },
                    { 2, "Snack", "Hamburguer de 4 carnes com queijo, presunto e molho da casa. Acompanha de frango e bacon.", true, "Hamburguer 4 carnes", 50.95m },
                    { 3, "Accompaniment", "Uma salada ceasar bem temperada.", true, "Salada Ceasar", 15.95m },
                    { 4, "Accompaniment", "Deliciosos onion rings com cebola e tomate.", true, "Onion Rings", 20.95m },
                    { 5, "Drink", "Coca-Cola Lata de 350ML para matar a sua sede!", true, "Coca-Cola Lata", 4.50m },
                    { 6, "Drink", "Heineken Longneck bem gelada.", true, "Heineken Longneck", 5.50m },
                    { 7, "Dessert", "Uma deliciosa casquinha de chocolate com sorvete de leite.", true, "Sorvete de casquinha - chocolate", 3.34m },
                    { 8, "Dessert", "Um incrível milkshake de morango com leite e chocolate.", true, "Milkshake de morango e chocolate", 10.0m }
                });
